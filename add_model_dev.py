...
def main(dataset_orig_panel19_train, dataset_orig_panel19_val, dataset_orig_panel19_test,unprivileged_groups, privileged_groups, descript_dict, revert_dct, df_panel_19_reduced):
    ...
    print(clf_age_lr_model.score(val_age, dataset_orig_panel19_val.labels.ravel()))

    print(clf_age_lr_model.score(test_age, dataset_orig_panel19_test.labels.ravel()))
